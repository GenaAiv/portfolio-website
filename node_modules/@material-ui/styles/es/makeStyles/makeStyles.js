...
function attach({
  ...
  const options = _extends(_extends(_extends({}, stylesCreator.options), stylesOptions), {}, {
    theme,
...
export default function makeStyles(stylesOrCreator, options = {}) {
  ...
  const useStyles = (props = {}) => {
    ...
    const stylesOptions = _extends(_extends({}, React.useContext(StylesContext)), stylesOptions2);
